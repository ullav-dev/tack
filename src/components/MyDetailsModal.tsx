...
function AvatarPreview({ url, initials }: { url: string; initials: string }) {
  ...
  if (!url || broken) {
    return (
      <div className="w-16 h-16 rounded-full bg-rose-100 flex items-center justify-center text-rose-700 text-lg font-semibold select-none">
        {initials}
      </div>
    );
  }
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <input
                ...
                placeholder="https://…"
                className="w-full text-sm border border-slate-300 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent"
              />
              <div className="flex gap-2 mt-1.5">
                <button
                  ...
                  className="text-xs text-rose-700 hover:text-rose-900 transition-colors disabled:opacity-50"
                >
        ...
        <div className="flex justify-end gap-3 px-6 py-4 border-t border-slate-200">
          ...
          <button
            ...
            onClick={handleSave}
            disabled={saving}
            className="px-4 py-2 text-sm font-medium bg-rose-700 hover:bg-rose-800 text-white rounded-lg transition-colors disabled:opacity-60"
          >
